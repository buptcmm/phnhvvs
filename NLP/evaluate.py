...
def evaluate_hv(soluong, start, end, hnet, net, ref_point,val_loader, embedding_matrix, device):
  #print('Evaluate')
  results = []
  ...
  return compute_hv(results.T, ref_point), np.array(results, dtype='float32'), min_penalty
