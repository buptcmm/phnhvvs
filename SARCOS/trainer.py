...
def train_MSH(solver,
    ...
    for epoch in epoch_iter:
        ...
        if val_epoch_results["hv"] > val_hv:
            ...
            torch.save(hnet,'save_models/SARCOS_MH_Freely1_'+ str(head) + "_" + str(lamda) + '_best.pt')
    ...
    hnet = torch.load('/root/cmm/mhe/SARCOS/save_models/SARCOS_MH_Freely1_'+ str(head) + "_" + str(lamda) + '_best.pt')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpus", type=str, default="6", help="gpu device")
    parser.add_argument(
        "--optim",
        type=str,
        default="adam",
    ...
    test_rays = sample_n_points_from_voronoi(best_voronoi_cells, 100)
    # sys.stdout = open("log/Sarcos_MH_Freely1_"+ str(head) + "_" + str(lamda) + "_log.txt", 'w')
    train_MSH(solver,
        hnet,
        net,
        optimizer,
